...
public class OrganizadorEventCardPanel extends JPanel {
    ...
    public OrganizadorEventCardPanel(String nombreEvento, String gananciasTexto) {
        ...
        // TODO: listeners reales más adelante
        // btnLocalidades.addActionListener(...);
        // btnDescuento.addActionListener(...);
    }
