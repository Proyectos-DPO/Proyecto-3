...
public class EventoMusical extends Evento{
	...
	public EventoMusical(String nombre, LocalDate fecha, LocalTime hora, double cargoPorcentual,
			Venue venue, Organizador organizador) {
		super(nombre, fecha, hora, venue, organizador);
	}
	
	//Persisting
	public EventoMusical(String nombre, LocalDate fecha, LocalTime hora, int cantidadBoletas,
