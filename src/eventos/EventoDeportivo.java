...
public class EventoDeportivo extends Evento{
	...
	public EventoDeportivo(String nombre, LocalDate fecha, LocalTime hora, double cargoPorcentual,
	...
	//Persisting
	public EventoDeportivo(String nombre, LocalDate fecha, LocalTime hora, int cantidadBoletas,
